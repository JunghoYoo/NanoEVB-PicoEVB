...
(* CORE_GENERATION_INFO = "bd_e547,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_e547,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1_microblaze_mcs_0_0.hwdef" *) 
module bd_e547
   (Clk,
    Reset,
    UART_rxd,
    UART_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN design_1_xdma_0_0_axi_aclk, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  bd_e547_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_e547_ilmb_cntlr_0 ilmb_cntlr
       (.BRAM_Addr_A(ilmb_port_ADDR),
        ...
        .Sl_UE(ilmb_sl_0_UE),
        .Sl_Wait(ilmb_sl_0_WAIT));
  bd_e547_iomodule_0_0 iomodule_0
       (.Clk(Clk1),
        .LMB_ABus(dlmb_sl_0_ABUS),
        .LMB_AddrStrobe(dlmb_sl_0_ADDRSTROBE),
        .LMB_BE(dlmb_sl_0_BE),
  ...
  bd_e547_lmb_bram_I_0 lmb_bram_I
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  bd_e547_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk1),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
