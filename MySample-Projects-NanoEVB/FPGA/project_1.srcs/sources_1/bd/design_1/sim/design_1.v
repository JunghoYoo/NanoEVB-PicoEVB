...
module StatusLEDControl_imp_1T9W95I
   (CLK,
    Res,
    link_up,
    reset_I);
  ...
  assign CLK_1 = CLK;
  assign Op1_1 = link_up[0];
  assign Res[0] = util_vector_logic_5_Res;
  assign sys_rst_n_1 = reset_I[0];
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=36,numReposBlks=29,numNonXlnxBlks=0,numHierBlks=7,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=9,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (RxD,
    SPI_0_io0_i,
    SPI_0_io0_o,
  ...
  output TxD;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 auxio TRI_I" *) input [3:0]auxio_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 auxio TRI_O" *) output [3:0]auxio_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 auxio TRI_T" *) output [3:0]auxio_tri_t;
  output [0:0]clkreq_l;
  input [1:0]di_edge;
  output [1:0]do_edge;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sys, CAN_DEBUG false, FREQ_HZ 100000000" *) input [0:0]sys_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 sys CLK_P" *) input [0:0]sys_clk_p;
  ...
  wire [7:0]xdma_0_c2h_sts_0;
  wire [7:0]xdma_0_h2c_sts_0;
  ...
  wire [15:0]xlconstant_4_dout;
  wire [1:0]xlslice_0_Dout;
  wire [0:0]xlslice_1_Dout;

  assign CLK_IN_D_0_1_CLK_N = sys_clk_n[0];
  assign CLK_IN_D_0_1_CLK_P = sys_clk_p[0];
  ...
  assign TxD = microblaze_mcs_0_UART_txd;
  assign UART_rxd_0_1 = RxD;
  assign auxio_tri_o[3:0] = axi_gpio_0_GPIO2_TRI_O;
  assign auxio_tri_t[3:0] = axi_gpio_0_GPIO2_TRI_T;
  assign axi_gpio_0_GPIO2_TRI_I = auxio_tri_i[3:0];
  ...
  assign clkreq_l[0] = clkreq_I_tieoff_dout;
  assign do_edge[1:0] = xlslice_0_Dout;
  assign gpio_io_i_0_1 = di_edge[1:0];
  assign pcie_mgt_txn[0] = xdma_0_pcie_mgt_txn;
  assign pcie_mgt_txp[0] = xdma_0_pcie_mgt_txp;
  assign status_leds[2:0] = xlconcat_0_dout;
  assign sys_rst_n_0_1 = sys_rst_n;
  assign xdma_0_pcie_mgt_rxn = pcie_mgt_rxn[0];
  assign xdma_0_pcie_mgt_rxp = pcie_mgt_rxp[0];
  StatusLEDControl_imp_1T9W95I StatusLEDControl
       (.CLK(xdma_0_axi_aclk),
        .Res(StatusLEDControl_Res),
        .link_up(util_vector_logic_0_Res),
        .reset_I(sys_rst_n_0_1));
  ...
  design_1_xdma_0_axi_periph_0 axi_interconnect_0
  ...
  design_1_xlconstant_5_0 clkreq_I_tieoff
       (.dout(clkreq_I_tieoff_dout));
  design_1_ila_0_1 ila_0
       (.clk(xdma_0_axi_aclk),
        .probe0(xdma_0_user_lnk_up),
        .probe1(xdma_0_c2h_sts_0),
        .probe2(xdma_0_h2c_sts_0));
  design_1_microblaze_mcs_0_0 microblaze_mcs_0
       (.Clk(xdma_0_axi_aclk),
        .Reset(xdma_0_axi_aresetn),
  ...
  design_1_xdma_0_0 xdma_0
       (.axi_aclk(xdma_0_axi_aclk),
        ...
        .c2h_sts_0(xdma_0_c2h_sts_0),
        .cfg_dev_id_pf0(xlconstant_3_dout),
        .cfg_rev_id_pf0(xlconstant_2_dout),
        .cfg_subsys_id_pf0(xlconstant_4_dout),
        .cfg_subsys_vend_id(xlconstant_1_dout),
        .cfg_vend_id(xlconstant_1_dout),
        .h2c_sts_0(xdma_0_h2c_sts_0),
